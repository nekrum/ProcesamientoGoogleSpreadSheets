...
[rostros.zip](rostros.zip) estan los datos y el archivo [codebook.txt](codebook.txt) tiene la descripción de las variables.
...
```{r Lectura en línea, eval=FALSE}
rostros.data <- read_tsv(
  "https://github.com/nekrum/ProcesamientoGoogleSpreadSheets/raw/master/rostros.zip",
  progress = FALSE,
  col_types = cols()
)
```
